...
set "Lib_Type_Args[1]=-DBUILD_SHARED_LIBS=OFF"
set "Lib_Type_Name[1]=static"
set "Lib_Type[2]=STATIC-LTO"
set "Lib_Type_Args[2]=-DBUILD_SHARED_LIBS=OFF -DINTERPROCEDURAL_OPTIMIZATION=ON -DCMAKE_LINKER_TYPE=LLD"
set "Lib_Type_Name[2]=static-lto"
set "Lib_Type[3]=SHARED"
set "Lib_Type_Args[3]=-DBUILD_SHARED_LIBS=ON"
