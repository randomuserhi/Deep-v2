...
using Arg_HierarchicalBitMask = const HierarchicalBitMask<in_N, in_Policy>&;

template<size_t in_N, StoragePolicy in_Policy>
constexpr Deep_ForceInline HierarchicalBitMask<in_N, in_Policy> operator|(HierarchicalBitMask<in_N, in_Policy>,
                                                                          Arg_HierarchicalBitMask<in_N, in_Policy>);
...
template<size_t in_N, StoragePolicy in_Policy>
constexpr inline bool operator==(Arg_HierarchicalBitMask<in_N, in_Policy>, Arg_HierarchicalBitMask<in_N, in_Policy>);
template<size_t in_N, StoragePolicy in_Policy>
constexpr Deep_ForceInline bool operator!=(Arg_HierarchicalBitMask<in_N, in_Policy>,
                                           Arg_HierarchicalBitMask<in_N, in_Policy>);
...
//
// TODO(randomuserhi): Documentation on underlying tree representation
template<size_t in_N, StoragePolicy in_Policy>
class HierarchicalBitMask {
	static_assert(in_N > 0, "Bit mask must contain atleast 1 bit.");
	using Storage = detail::_HierarchicalBitMask::Storage<in_N, in_Policy>;
...
public:
	...
	friend constexpr bool operator== <in_N, in_Policy>(Arg_HierarchicalBitMask<in_N, in_Policy>,
	                                                   Arg_HierarchicalBitMask<in_N, in_Policy>);
	friend constexpr bool operator!= <in_N, in_Policy>(Arg_HierarchicalBitMask<in_N, in_Policy>,
	                                                   Arg_HierarchicalBitMask<in_N, in_Policy>);

	constexpr inline HierarchicalBitMask& operator|=(Arg_HierarchicalBitMask<in_N, in_Policy> in_other);
	friend constexpr HierarchicalBitMask operator| <in_N, in_Policy>(HierarchicalBitMask,
	                                                                 Arg_HierarchicalBitMask<in_N, in_Policy>);
...
static_assert(c_BitMask<HierarchicalBitMask<32, StoragePolicy::e_stack>>);
static_assert(c_BitMask<HierarchicalBitMask<32, StoragePolicy::e_heap>>);

DEEP_NAMESPACE_END

#include "./HierarchicalBitMask.inl" // IWYU pragma: export
