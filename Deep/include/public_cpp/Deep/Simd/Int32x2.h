...
struct [[nodiscard]] alignas(DEEP_VEC_ALIGNMENT) Int32x2 {
	...
	friend inline Int32x2 operator~(Int32x2 in_value);
...
static_assert(std::is_trivial_v<Int32x2>, "Is supposed to be a trivial type!");
static_assert(std::is_standard_layout_v<Int32x2>, "Is supposed to be standard layout!");

DEEP_NAMESPACE_END

#undef DEEP_VEC_ALIGNMENT

#include "./Int32x2.inl" // IWYU pragma: export
