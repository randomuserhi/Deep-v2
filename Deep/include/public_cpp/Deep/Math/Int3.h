...
static_assert(std::is_trivial_v<Int3>, "Is supposed to be a trivial type!");
static_assert(std::is_standard_layout_v<Int3>, "Is supposed to be standard layout!");
