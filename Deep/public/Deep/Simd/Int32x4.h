...
struct [[nodiscard]] alignas(DEEP_VEC_ALIGNMENT) Int32x4 {
	...
	constexpr inline Int32x4(Type in_internal);
	...
	static inline Int32x4 Max(Arg_Int32x4 in_a, Arg_Int32x4 in_b);
...
static_assert(std::is_trivial<Int32x4>(), "Is supposed to be a trivial type!");
static_assert(std::is_standard_layout<Int32x4>(), "Is supposed to be standard layout!");
