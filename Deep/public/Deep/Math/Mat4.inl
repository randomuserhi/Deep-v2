...
Mat4::Mat4(SSE_m128 in_col0, SSE_m128 in_col1, SSE_m128 in_col2, SSE_m128 in_col3) :
...
Mat4::Mat4(                                                         //
    ...
    m_cols{
        SSE_m128(in_m00, in_m10, in_m20, in_m30), //
        SSE_m128(in_m01, in_m11, in_m21, in_m31), //
        SSE_m128(in_m02, in_m12, in_m22, in_m32), //
        SSE_m128(in_m03, in_m13, in_m23, in_m33)  //
    } {}
...
Mat4 Mat4::inversed() const {
    ...
    Mat4 result{
        SSE_m128{ m11 * n22333223 - m21 * n12333213 + m31 * n12232213, -m01 * n22333223 + m21 * n02333203 - m31 * n02232203,
                  m01 * n12333213 - m11 * n02333203 + m31 * n02131203,
                  -m01 * n12232213 + m11 * n02232203 - m21 * n02131203 },
        SSE_m128{ -m10 * n22333223 + m20 * n12333213 - m30 * n12232213, m00 * n22333223 - m20 * n02333203 + m30 * n02232203,
                  -m00 * n12333213 + m10 * n02333203 - m30 * n02131203,
                  m00 * n12232213 - m10 * n02232203 + m20 * n02131203 },
        SSE_m128{ m10 * n21333123 - m20 * n11333113 + m30 * n11232113, -m00 * n21333123 + m20 * n01333103 - m30 * n01232103,
                  m00 * n11333113 - m10 * n01333103 + m30 * n01131103,
                  -m00 * n11232113 + m10 * n01232103 - m20 * n01131103 },
        SSE_m128{ -m10 * n21323122 + m20 * n11323112 - m30 * n11222112, m00 * n21323122 - m20 * n01323102 + m30 * n01222102,
...
Deep_Inline bool operator!=(Mat4Arg in_a, Mat4Arg in_b) {
    return SSE_m128i::And(SSE_m128i::And(SSE_m128::Equals(in_a.m_cols[0], in_b.m_cols[0]),
                                         SSE_m128::Equals(in_a.m_cols[1], in_b.m_cols[1])),
                          SSE_m128i::And(SSE_m128::Equals(in_a.m_cols[2], in_b.m_cols[2]),
                                         SSE_m128::Equals(in_a.m_cols[3], in_b.m_cols[3])))
               .ToBooleanBitMask()
           != 0b1111;
}
Deep_Inline bool operator==(Mat4Arg in_a, Mat4Arg in_b) {
...
Vec3 operator*(Mat4Arg in_mat, Vec3Arg in_vec) {
    Vec3 _v;
#ifdef DEEP_USE_SSE4_1
    _v.sse_m128 = _mm_mul_ps(in_mat.m_cols[0], _mm_shuffle_ps(in_vec.sse_m128, in_vec.sse_m128, _MM_SHUFFLE(0, 0, 0, 0)));
    _v.sse_m128 =
        _mm_add_ps(_v.sse_m128,
                   _mm_mul_ps(in_mat.m_cols[1], _mm_shuffle_ps(in_vec.sse_m128, in_vec.sse_m128, _MM_SHUFFLE(1, 1, 1, 1))));
    _v.sse_m128 =
        _mm_add_ps(_v.sse_m128,
                   _mm_mul_ps(in_mat.m_cols[2], _mm_shuffle_ps(in_vec.sse_m128, in_vec.sse_m128, _MM_SHUFFLE(2, 2, 2, 2))));
    _v.sse_m128 = _mm_add_ps(_v.sse_m128, in_mat.m_cols[3]);
#else
...
Vec4 operator*(Mat4Arg in_mat, Vec4Arg in_vec) {
    ...
    _v.sse_m128 =
        _mm_add_ps(_v.sse_m128,
                   _mm_mul_ps(in_mat.m_cols[3], _mm_shuffle_ps(in_vec.sse_m128, in_vec.sse_m128, _MM_SHUFFLE(3, 3, 3, 3))));
#else
