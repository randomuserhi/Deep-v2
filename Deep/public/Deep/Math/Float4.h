...
static_assert(std::is_trivial_v<Float4>, "Is supposed to be a trivial type!");
static_assert(std::is_standard_layout_v<Float4>, "Is supposed to be standard layout!");

DEEP_NAMESPACE_END

#include "./Float4.inl" // IWYU pragma: export
