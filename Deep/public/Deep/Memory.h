...
Deep_ForceInline void* Malloc(size_t in_size) noexcept;
Deep_ForceInline void* Realloc(void* in_old, size_t in_size) noexcept;
...
Deep_ForceInline void* AlignedMalloc(size_t in_size, size_t in_alignment) noexcept;
...
template<typename T>
Deep_ForceInline T* TMalloc(size_t in_size) noexcept;
...
template<typename T>
Deep_ForceInline T* TRealloc(T* in_old, size_t in_size) noexcept;
